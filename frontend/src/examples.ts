// Auto-generated from the legacy ltxmojo examples.js (master branch,
// lib/LaTeXML/Plugin/LtxMojo/public/js/editor/examples.js). Labels and
// order match the original `editor.html.ep` example_select dropdown,
// followed by examples that the original UI defined but did not surface
// (clc, met, rand).
export const EXAMPLES: Record<string, string> = {
  "Equations": String.raw`\section{The Lorenz Equations}
\[\begin{aligned}
\dot{x} & = \sigma(y-x) \\
\dot{y} & = \rho x - y - xz \\
\dot{z} & = -\beta z + xy
...
Source: \url{http://www.mathjax.org/demos/tex-samples/}`,

  "Tables": String.raw`\section{First Example}
...
Source: \url{http://amath.colorado.edu/documentation/LaTeX/reference/tables/}`,
  ...
  "Narrative": String.raw`\documentclass{amsart}
...
\end{document}`,
  ...
  "Babel": String.raw`\documentclass[a4paper]{book}
...
\end{document}`,
  ...
  "Unicode": String.raw`\documentclass{article}
...
\end{document}`,
  ...
  "Color": String.raw`The 68 standard colors known to dvips\vspace{0.5ex}
...
Source: \url{http://people.oregonstate.edu/~peterseb/tex/samples/color-package.html}`,
  ...
  "PSTricks Graphics": String.raw`\documentclass{article}
\usepackage{pstricks}
\begin{document}
...
\end{document}`,
  ...
  "Wiki Syntax": String.raw`\usepackage{wiki}
\begin{document}
\wikimarkup
...
\end{document}`,
  ...
  "Boxes": String.raw`\documentclass{article}
...
\end{document}`,
  ...
  "Tikz Basic": String.raw`\documentclass{article}\usepackage{tikz}\begin{document}
...
\end{tikzpicture}\end{document}`,
  ...
  "Tikz AC Voltage": String.raw`% Behaviour of the stator voltage and the RMS-value of the stator
...
\end{document}`,
  ...
  "Tikz Rotated Triangle": String.raw`\documentclass{article}
...
\end{document}`,
  ...
  "Calculus": String.raw`Behold: $\int_0^\infty x\,dx$ is an integral`,

  "PlanetMath": String.raw`\usepackage{planetmath-specials}
\begin{document}
